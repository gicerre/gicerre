...
Hey! I’m a full-stack developer who loves turning ideas into real projects and experimenting with new technologies. When I’m not coding, you’ll probably find me reading manga, drawing, listening to music, or watching a good movie.

I enjoy creating things just for the fun of learning, from small experiments to bigger open-source projects. If something I build is useful or inspires you, and you feel like supporting my work, buying me a coffee is always hugely appreciated. It helps me keep creating, learning, and sharing new projects with the community.

Thanks for stopping by and for supporting independent creators! ☕

- ⌖ **Location** · Leghorn, Italy
- ⌗ **Experience** · 5+ years
- ◎ **Education** · Master’s Degree in Digital Humanities
- ⟳ **Learning** · Rust, product strategy, and better DX tooling

### Featured Projects

- [LlamaDesk](https://github.com/gicerre/llamadesk) — LlamaDesk is a desktop application that holds the context of a project: its links, its web consoles, its local folders, its Git repositories — and the tools those things open with

### Stack

**Languages**

<img src="https://skillicons.dev/icons?i=ts,python,js,java,cs,php,html,css&theme=dark" alt="Languages"/>

**Frontend**

<img src="https://skillicons.dev/icons?i=react,nextjs,tailwind,vue,svelte,angular,nuxtjs,vite,bootstrap,flutter&theme=dark" alt="Frontend"/>

**Backend & Databases**

<img src="https://skillicons.dev/icons?i=nodejs,postgres,prisma,express,fastapi,spring,mysql,mongodb,firebase,supabase&theme=dark" alt="Backend & Databases"/>

**DevOps & Cloud**

<img src="https://skillicons.dev/icons?i=docker,vercel,githubactions,aws,gcp,azure,nginx,vscode,git,linux,kubernetes&theme=dark" alt="DevOps & Cloud"/>

**AI / ML**

<img src="https://skillicons.dev/icons?i=jupyter,numpy,pandas&theme=dark" alt="AI / ML"/>
